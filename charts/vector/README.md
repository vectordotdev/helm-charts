...
![Version: 0.42.1](https://img.shields.io/badge/Version-0.42.1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 0.46.1-distroless-libc](https://img.shields.io/badge/AppVersion-0.46.1--distroless--libc-informational?style=flat-square)
...
| topologySpreadConstraints | list | `[]` | Configure [topology spread constraints](https://kubernetes.io/docs/concepts/scheduling-eviction/topology-spread-constraints/) for Vector Pods. Valid for the "Aggregator" and "Stateless-Aggregator" roles.  If no "labelSelector" is defined, Vector's selector labels will be used by default. |
