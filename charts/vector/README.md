...
| service.loadBalancerIP | string | `""` | Set the [loadBalancerIP](https://kubernetes.io/docs/concepts/services-networking/service/#loadbalancer) for Vector's Service. |
| service.ipFamilyPolicy | string | `""` | Set the ipFamilyPolicy for Vector's Service. See [IPv4/IPv6 dual-stack](https://kubernetes.io/docs/concepts/services-networking/dual-stack/) for details. |
| service.ipFamilies | list | `[]` | Set the ipFamilies for Vector's Service. See [IPv4/IPv6 dual-stack](https://kubernetes.io/docs/concepts/services-networking/dual-stack/) for details. |
| service.externalTrafficPolicy | string | `""` | Set the [externalTrafficPolicy](https://kubernetes.io/docs/tasks/access-application-cluster/create-external-load-balancer/#preserving-the-client-source-ip) for Vector's Service. |
...
| haproxy.service.externalTrafficPolicy | string | `""` | Set the [externalTrafficPolicy](https://kubernetes.io/docs/tasks/access-application-cluster/create-external-load-balancer/#preserving-the-client-source-ip) for HAProxy's Service. |
| haproxy.service.loadBalancerIP | string | `""` | Set the [loadBalancerIP](https://kubernetes.io/docs/concepts/services-networking/service/#loadbalancer) for HAProxy's Service. |
| haproxy.service.ipFamilyPolicy | string | `""` | Set the ipFamilyPolicy for HAProxy's Service. See [IPv4/IPv6 dual-stack](https://kubernetes.io/docs/concepts/services-networking/dual-stack/) for details. |
| haproxy.service.ipFamilies | list | `[]` | Set the ipFamilies for HAProxy's Service. See [IPv4/IPv6 dual-stack](https://kubernetes.io/docs/concepts/services-networking/dual-stack/) for details. |
