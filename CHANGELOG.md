...
## [vector-0.43.1] - 2025-06-24

### README

#### Documentation

- Intended recent available links (#402) ([342336d](https://github.com/vectordotdev/helm-charts/commit/342336dbc64a5eb71be7709496b848c09ef1e178))
...
- Update Vector version to 0.46.1 and Helm docs (#475) ([174cc6a](https://github.com/vectordotdev/helm-charts/commit/174cc6a76d182cd9aded8886042db3edeae71817))
...
- Generate Vector 0.2.1 CHANGELOG (#119) ([fa5a909](https://github.com/vectordotdev/helm-charts/commit/fa5a909616a9462a4b30a3f3597e9cad06aaf186))
...
- Fix conditionals for existingConfigMaps and haproxy.existingConfigMap (#182) ([87ca537](https://github.com/vectordotdev/helm-charts/commit/87ca537b54f9956c434ddbbd3cfcc9942d7e9c07))
  - **BREAKING**: fix conditionals for existingConfigMaps and haproxy.existingConfigMap (#182)
- Use haproxy.image.tag as its version label value (#183) ([3983653](https://github.com/vectordotdev/helm-charts/commit/39836533d6f8c41c07ddb341641e0fe328537234))
  - **BREAKING**: use haproxy.image.tag as its version label value (#183)
- Bump Vector to v0.20.1 (#195) ([f3825de](https://github.com/vectordotdev/helm-charts/commit/f3825de8a49f1f16ecfa9d83a043d3c2c9db48ff))
- Bump image to 0.21.1 (#202) ([738b68e](https://github.com/vectordotdev/helm-charts/commit/738b68e446164f6b6e6a8a6f486f9ede18a90291))
- No need to set replicas to statefulset  when using hpa (#203) ([fd2040b](https://github.com/vectordotdev/helm-charts/commit/fd2040b0b987977168a445d8ea3633578bddbbf5))
- Bump Vector version v0.22.2 (#220) ([4f54ad0](https://github.com/vectordotdev/helm-charts/commit/4f54ad06d141480c100cf5a39458545e2b3e1fdb))
- Bump Vector version to 0.22.3 (#225) ([f10423d](https://github.com/vectordotdev/helm-charts/commit/f10423d15fe58b476540504dcd2169607f8d47cb))
...
- Actually release version bump (#235) ([d6bb6b6](https://github.com/vectordotdev/helm-charts/commit/d6bb6b6ffa96996ecda6b9ea18ef3214e90c3772))
...
- :bug: pod tpl (#252) ([c683684](https://github.com/vectordotdev/helm-charts/commit/c68368447b774a33019a6211579742841c72c0d4))
...
- Update to Vector 0.25.2 (#274) ([e78a736](https://github.com/vectordotdev/helm-charts/commit/e78a736ca2e78e4dfb5ada7b613ca8d35ed12da4))
...
- Bump Vector chart to 0.28.2 (#293) ([1b384e9](https://github.com/vectordotdev/helm-charts/commit/1b384e941b84483177be476c96134b9ae91ec7d6))
- Bump Vector chart to v0.29.1 (#300) ([3cb03be](https://github.com/vectordotdev/helm-charts/commit/3cb03beb1d7f91aa5fcd6c34d0248da474057e19))
...
- Bump Vector to 0.32.1 (#321) ([1f51325](https://github.com/vectordotdev/helm-charts/commit/1f51325afac672959b477732eb65265ec89c1a54))
- Bump Vector version to v0.32.2 (#332) ([781b414](https://github.com/vectordotdev/helm-charts/commit/781b414d1929826ae388e087b8d0e664fa6925b4))
- Bump Vector to 0.34.1 (#343) ([00c9a2c](https://github.com/vectordotdev/helm-charts/commit/00c9a2cc17cfe41a378db86d046227d24df04559))
...
- Bump to Vector v0.35.1 (#368) ([64ea7a5](https://github.com/vectordotdev/helm-charts/commit/64ea7a50c64fad3a520643f46be5209f74b71c6c))
...
- (revert) add minReadySeconds to StatefulSet and Deployment specs (#371) ([9331e8c](https://github.com/vectordotdev/helm-charts/commit/9331e8c9858dc46e94e9d7139b6e7912c0f2f834))
- Add minReadySeconds to StatefulSet and Deployment specs (#372) ([d9d9836](https://github.com/vectordotdev/helm-charts/commit/d9d9836932f85004047cd69cd0d7dd6f69bbe131))
...
- Bump Vector version to v0.36.1 (#378) ([a24d31e](https://github.com/vectordotdev/helm-charts/commit/a24d31ee067b4dffcfac039f827322abd850552a))
- Bump Vector to v0.37.1 (#384) ([fe70554](https://github.com/vectordotdev/helm-charts/commit/fe70554b361108ba055c3de3f0d55e47988941f9))
...
- Add `namespace` to manifests (#394) ([72ffb20](https://github.com/vectordotdev/helm-charts/commit/72ffb20576cf4141b6881ada2660fdaadf2e22ad))
- Revert add `namespace` to manifests" (#401) ([d975a43](https://github.com/vectordotdev/helm-charts/commit/d975a43e8e259c0e289c49ccf322d87b23bd3b3d))
- Add hostAliases in pod spec (#403) ([55bb261](https://github.com/vectordotdev/helm-charts/commit/55bb261245e11ffdd48c89cb7206abaa1ceb460c))
- Bump to Vector v0.40.1 (#404) ([abd6edd](https://github.com/vectordotdev/helm-charts/commit/abd6eddc43c762f8e800fd28539f9e5dcef5351f))
...
- Support injecting multiple ConfigMaps (#58) ([337d7d2](https://github.com/vectordotdev/helm-charts/commit/337d7d231ee1d307987fe4945a37bfa6f44c5342))
  - **BREAKING**: Support injecting multiple ConfigMaps (#58)
...
- Update secrets.generic to take unencoded values (#84) ([5f66c18](https://github.com/vectordotdev/helm-charts/commit/5f66c1865851894df9d682ffea688f2c95662cf7))
  - **BREAKING**: Updated secret.yaml template to receive raw strings that it then `b64enc` better aligning with Datadog Helm chart usage
...
- Bump image to 0.21.0 (#199) ([f2c4272](https://github.com/vectordotdev/helm-charts/commit/f2c4272d99b0e4b8485d30843fb88a9594eda96d))
- Add RBAC to list and watch nodes (#211) ([ebca1b4](https://github.com/vectordotdev/helm-charts/commit/ebca1b49a5ea0a253aecbe70c38e2047ca97f334))
- Bump chart appVersion to 0.22.0 (#215) ([6de0510](https://github.com/vectordotdev/helm-charts/commit/6de0510d7fee60d116b3cb06d8e06fcebffa824e))
- Add digest option to vector image (#219) ([cf0f4c1](https://github.com/vectordotdev/helm-charts/commit/cf0f4c1f7e9272ac2191908afcce03ab59e2d13c))
...
- Bump Vector to 0.23.0 (#227) ([b4d42b4](https://github.com/vectordotdev/helm-charts/commit/b4d42b46500285a8c02572c271b1e078361b0369))
- Add lifecycle hooks (#230) ([230b7d9](https://github.com/vectordotdev/helm-charts/commit/230b7d990cdd5c983abe549e00fe0c49250d159d))
- Add support for setting the pod hostNetwork (#213) (#238) ([e62e12d](https://github.com/vectordotdev/helm-charts/commit/e62e12d9f96f7594f57c1578d7d18ce127173f47))
- Bump to Vector 0.24.0 (#240) ([356aa4e](https://github.com/vectordotdev/helm-charts/commit/356aa4e870d0091c2de468569b89c620d05916fa))
...
- :sparkles: Release 2022-10-04 (#247) ([91d0b12](https://github.com/vectordotdev/helm-charts/commit/91d0b120e6b2c8cad555ead8f3da02b8e2d32847))
...
- Update Vector image to 0.25.1 (#270) ([29beb7e](https://github.com/vectordotdev/helm-charts/commit/29beb7ead8b43825a6099d08fdb6cf815f361687))
- Upgrade chart to Vector 0.26.0 (#275) ([598fe91](https://github.com/vectordotdev/helm-charts/commit/598fe91d055cce25f3ef65c0d53bdada2bfb9898))
- Bump to v0.27.0 release of Vector (#277) ([d474f92](https://github.com/vectordotdev/helm-charts/commit/d474f92de85db915ec539d76081e964c53eb39eb))
...
- Bump Vector version to 0.28.0 (#285) ([df2cedf](https://github.com/vectordotdev/helm-charts/commit/df2cedf6393e28c3dd5382db4bff930d3e5bf56e))
- Bump Vector to 0.29.0 (#294) ([ded9c40](https://github.com/vectordotdev/helm-charts/commit/ded9c40bc357e925f3725647cfe362b782c6ad36))
...
- Bump Vector version to 0.30.0 (#304) ([8730c05](https://github.com/vectordotdev/helm-charts/commit/8730c056ce107a2f12459ff2ac8a4639913976e0))
- Regenerate CHANGELOG (#311) ([3feb917](https://github.com/vectordotdev/helm-charts/commit/3feb917ec7997ee6ee2cd6ef8761f67cc9bcff6a))
...
- Bump Vector image to 0.31.0 (#313) ([e069a13](https://github.com/vectordotdev/helm-charts/commit/e069a13d0931aabe6381b1a99f6a943a4a6efa75))
- Bump Vector to 0.32.0 (#318) ([86be602](https://github.com/vectordotdev/helm-charts/commit/86be602e5abdfe3e64a6dc51dc399869a75e957a))
...
- Bump Vector version to v0.33.0 (#334) ([69cb33f](https://github.com/vectordotdev/helm-charts/commit/69cb33f03cfb44fcd6e937c43c571f374c2c6474))
- Bump charts to Vector v0.33.1 (#338) ([00f1ada](https://github.com/vectordotdev/helm-charts/commit/00f1ada729fb66e93e4d99fdb10be9769063ee86))
- Bump to Vector v0.34.0 (#342) ([ebdc76b](https://github.com/vectordotdev/helm-charts/commit/ebdc76b1b0955f6bae8bd444b3b00de0d745dd24))
...
- Bump to Vector v0.34.2 (#352) ([3c98786](https://github.com/vectordotdev/helm-charts/commit/3c98786f8d9d299a9d6142ca64f5aeb7b73a76dd))
- Bump Vector to v0.35.0 (#353) ([8a60571](https://github.com/vectordotdev/helm-charts/commit/8a6057112eca3cc17cab12ca5c29fa9dba698707))
- Bump Vector version to v0.36.0 (#369) ([ef5481d](https://github.com/vectordotdev/helm-charts/commit/ef5481d5f6441ab6b8ff54b79d759629b907bc65))
- Bump Vector to v0.37.0 (#379) ([b0a88d4](https://github.com/vectordotdev/helm-charts/commit/b0a88d4ab1f975db198bf3ae7bdc51c400c2c487))
- Allow external autoscaler (#386) ([d03e980](https://github.com/vectordotdev/helm-charts/commit/d03e9804f3a3fe681e56903f659053a9289a88e4))
- Bump Vector version to v0.38.0 (#387) ([391a7fd](https://github.com/vectordotdev/helm-charts/commit/391a7fdb1b7d0c38ec969df0bde9e873c2eb48d5))
- Update the image fields to allow for a static base name (#388) ([1e26e7c](https://github.com/vectordotdev/helm-charts/commit/1e26e7cdbd62375d5bbe4111bd43a0cd98eb71ca))
- Bump Vector to v0.39.0 (#393) ([8b439c9](https://github.com/vectordotdev/helm-charts/commit/8b439c9fd7d3e191637c72691eb2a8d85db659b5))
- Update Vector to v0.40.0 (#400) ([d6a9dab](https://github.com/vectordotdev/helm-charts/commit/d6a9dabddcb0ada1d53ef9b7a4825f04f144e75c))
...
- Bump Vector to v0.46.1 (#475) ([174cc6a](https://github.com/vectordotdev/helm-charts/commit/174cc6a76d182cd9aded8886042db3edeae71817))


## [vector-0.42.0] - 2025-04-08
...
- Support tpl for init and extra containers. (#469) ([a3878ea](https://github.com/vectordotdev/helm-charts/commit/a3878eab9efc2477c4a97cc5a0e5920132836177))
- Update Vector version to 0.46.0 (#471) ([7af43f5](https://github.com/vectordotdev/helm-charts/commit/7af43f5c299505451869261d2efd8e1dbfb018fe))
- Regenerate CHANGELOG for 0.46.0 ([6c37e82](https://github.com/vectordotdev/helm-charts/commit/6c37e828c80044ac4a94fc8acffcc465ce1aefe0))
